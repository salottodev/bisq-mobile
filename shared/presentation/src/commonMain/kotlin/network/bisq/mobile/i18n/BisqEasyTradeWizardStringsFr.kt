...
val FrBisqEasyTradeWizardStrings = BisqEasyTradeWizardStrings(
    ...
    bisqEasy_tradeWizard_directionAndMarket_headline = "[FR] Do you want to buy or sell Bitcoin?",
    bisqEasy_tradeWizard_directionAndMarket_headlineWithCode = { currency -> "[FR] Do you want to buy or sell Bitcoin with $currency?" },
    ...
    bisqEasy_tradeWizard_review_priceDetails_fix = { percentage, direction, rate -> "[FR] Fix price. $percentage $direction market price of $rate" },
    bisqEasy_tradeWizard_review_priceDetails_fix_atMarket = { price -> "[FR] Fix price. Same as market price of $price" },

...
data class BisqEasyTradeWizardStrings(
    ...
    val bisqEasy_tradeWizard_directionAndMarket_headlineWithCode: (String) -> String,
    ...
    val bisqEasy_tradeWizard_review_priceDetails_fix: (String, String, String) -> String,
    val bisqEasy_tradeWizard_review_priceDetails_fix_atMarket: (String) -> String,

...
import network.bisq.mobile.presentation.private_chat.PrivateChatPresenter
...
val presentationModule =
    module {
        ...
        factory { TabContainerPresenter(get(), get(), get(), get(), get(), get(), get()) } bind ITabContainerPresenter::class
        ...
        factory { PeerProfilePresenter(get(), get(), get(), get(), get(), get(), get(), get(), get(), get(), get()) }

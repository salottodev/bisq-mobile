...
class ApplicationLifecycleServiceBootstrapTest : PresentationKoinTestBase() {
    /**
     ...
     * lifecycle service and the Sentry SDK shim. Work launched on
     * [network.bisq.mobile.data.service.BaseService.serviceScope] shares the
     * leaf base's [testDispatcher]; call [advanceUntilIdle] after
     * `initialize()` (and after mid-session settings flips) before asserting.
     */

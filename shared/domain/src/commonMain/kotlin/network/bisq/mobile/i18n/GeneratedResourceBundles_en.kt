...
object GeneratedResourceBundles_en {
    val bundles = mapOf(
        ...
        "application" to mapOf(
            ...
            "splash.bootstrapState.SERVICE_PUBLISHED" to "{0} published",
            ...
            "splash.bootstrapState.START_PUBLISH_SERVICE" to "Start publishing {0}",
            ...
            "splash.details.tooltip" to "Click to toggle details",
            ...
            "splash.bootstrapState.CONNECTED_TO_PEERS" to "Connecting to peers",
            ...
            "splash.bootstrapState.BOOTSTRAP_TO_NETWORK" to "Bootstrap to {0} network",
            ...
            "splash.applicationServiceState.INITIALIZE_NETWORK" to "Initialize P2P network",
            ...
            "updater.headline.isLauncherUpdate" to "A new Bisq installer is available",
        ...
        "bisq_easy" to mapOf(
            ...
            "bisqEasy.takeOffer.amount.seller.limitInfo.lowToleratedAmount" to "As the trade amount is below {0}, reputation requirements are relaxed.",
            ...
            "bisqEasy.tradeWizard.amount.seller.limitInfo.overlay.info.inSufficientScore" to "With a reputation score of {0}, the security you provide is insufficient for trades over {1}.\n\nYou can still create such offers, but buyers will be warned about potential risks when attempting to take your offer.\n\nYou can find information on how to increase your reputation at ''Reputation/Build Reputation''.",
            ...
            "bisqEasy.tradeCompleted.body.tradePrice" to "Trade price",
            ...
            "bisqEasy.component.amount.baseSide.tooltip.btcAmount.selectedPrice" to "This is the Bitcoin amount with your selected price.",
            ...
            "bisqEasy.tradeWizard.directionAndMarket.feedback.tradeWithoutReputation" to "Continue without reputation",
            ...
            "bisqEasy.tradeWizard.amount.seller.wizard.limitInfo" to "With your reputation score of {0}, you can trade up to",
            ...
            "bisqEasy.tradeGuide.process.headline" to "How does the trade process works?",
            "bisqEasy.mediator" to "Mediator",
            "bisqEasy.price.headline" to "What is your trade price?",
            ...
            "bisqEasy.tradeWizard.amount.seller.wizard.limitInfo.overlay.info" to "With a reputation score of {0}, you can trade up to {1}.\n\nYou can find information on how to increase your reputation at ''Reputation/Build Reputation''.",
            "bisqEasy.tradeState.info.seller.phase3b.balance.prompt" to "Waiting for blockchain data...",
            "bisqEasy.takeOffer.amount.buyer.limitInfo.minAmountCovered" to "Seller''s reputation score of {0} provides security up to",
            ...
            "bisqEasy.tradeWizard.amount.buyer.limitInfo.noReputationNeededForMaxOrFixedAmount" to "Sellers with no reputation can take offers up to {0}.",
            ...
            "bisqEasy.openTrades.failed.popup" to "The trade failed due an error.\nError message: {0}\n\nStack trace: {1}",
            "bisqEasy.tradeWizard.paymentMethods.fiat.subTitle.buyer" to "Choose the payment methods to transfer {0}",
            "bisqEasy.tradeWizard.market.subTitle" to "Choose your trade currency",
            ...
            "bisqEasy.tradeCompleted.title" to "Trade was successfully completed",
            "bisqEasy.tradeState.info.buyer.phase3b.headline.MAIN_CHAIN" to "The seller has started the Bitcoin payment",
            "bisqEasy.tradeWizard.amount.seller.limitInfo.overlay.info.sufficientScore" to "With a reputation score of {0}, you provide security for trades up to {1}.",
            ...
            "bisqEasy.tradeWizard.amount.description.minAmount" to "Set the minimum value for the amount range",
            ...
            "bisqEasy.tradeWizard.amount.seller.limitInfo.scoreTooLow" to "With your reputation score of {0}, your trade amount should not exceed",
            ...
            "bisqEasy.tradeWizard.amount.description.fixAmount" to "Set the amount you want to trade",
            ...
            "bisqEasy.tradeWizard.amount.seller.limitInfo.sufficientScore" to "Your reputation score of {0} provides security for offers up to",
            ...
            "bisqEasy.tradeWizard.amount.buyer.numSellers.1" to "is one seller",
            "bisqEasy.tradeGuide.tabs.headline" to "Trade guide",
            "bisqEasy.tradeWizard.amount.seller.limitInfo.inSufficientScore" to "The security provided by your reputation score of {0} is insufficient for offers over",
            "bisqEasy.openTrades.exportTrade" to "Export trade data",
            "bisqEasy.tradeWizard.review.table.reputation" to "Reputation",
            "bisqEasy.tradeWizard.amount.buyer.numSellers.0" to "is no seller",
            "bisqEasy.tradeWizard.progress.directionAndMarket" to "Offer type",
            "bisqEasy.offerDetails.direction" to "Offer type",
            "bisqEasy.tradeWizard.amount.buyer.numSellers.*" to "are {0} sellers",
            ...
            "bisqEasy.tradeWizard.review.priceDetails.fix" to "Fix price. {0} {1} market price of {2}",
            "bisqEasy.openTrades.tradeDetails.btcPaymentAddress" to "BTC payment address",
            "bisqEasy.tradeWizard.amount.description.maxAmount" to "Set the maximum value for the amount range",
            ...
            "bisqEasy.tradeWizard.review.priceDetails.fix.atMarket" to "Fix price. Same as market price of {0}",
            "bisqEasy.openTrades.tradeDetails.offerTypeAndMarket.fiatMarket" to "{0} market",
            "bisqEasy.tradeCompleted.tableTitle" to "Summary",
            "bisqEasy.tradeWizard.market.headline.seller" to "In which currency do you want to get paid?",
            "bisqEasy.tradeCompleted.body.date" to "Date",
            ...
            "bisqEasy.tradeState.info.seller.phase2b.headline" to "Check if you have received {0}",
            ...
            "bisqEasy.component.amount.baseSide.tooltip.btcAmount.marketPrice" to "This is the Bitcoin amount with current market price.",
            ...
            "bisqEasy.tradeWizard.amount.buyer.noReputationNeededForMinAmount.limitInfo" to "For the max. amount of {0} there {1} with enough reputation to take your offer.",
            ...
            "bisqEasy.component.amount.baseSide.tooltip.bestOfferPrice" to "This is the Bitcoin amount with the best price\nfrom matching offers: {0}",
            ...
            "bisqEasy.openTrades.failedAtPeer.popup" to "The peer''s trade failed due an error.\nError caused by: {0}\n\nStack trace: {1}",
            ...
            "bisqEasy.takeOffer.amount.buyer.limitInfo.tooHighMax" to "Seller''s reputation score is only {0}. It is not recommended to trade more than",
            "bisqEasy.privateChats.table.myUser" to "My profile",
            "bisqEasy.tradeState.info.phase4.exportTrade" to "Export trade data",
            "bisqEasy.takeOffer.amount.buyer.limitInfo.minAmountNotCovered" to "Seller''s reputation score of {0} does not provide sufficient security for that offer.",
            ...
            "bisqEasy.tradeCompleted.header.tradeId" to "Trade ID",
            "bisqEasy.tradeState.info.buyer.phase1a.bitcoinPayment.description.MAIN_CHAIN" to "Bitcoin address",
            "bisqEasy.tradeWizard.amount.seller.limitInfo.overlay.linkToWikiText" to "For more details about the reputation system, visit the Bisq Wiki at:",
            ...
            "bisqEasy.openTrades.tradeDetails.lightningInvoice.copy" to "Copy lighting invoice",
            ...
            "bisqEasy.tradeWizard.progress.amount" to "Amount",
            ...
            "bisqEasy.tradeWizard.market.headline.buyer" to "In which currency do you want to pay?",
            ...
            "bisqEasy.openTrades.failedAtPeer" to "The peer''s trade failed with an error caused by: {0}",
            ...
            "bisqEasy.tradeWizard.amount.buyer.noReputationNeededForMinAmount.limitInfo.leadLine" to "Since your min. amount is below {0}, sellers without reputation can take your offer.",
            ...
            "bisqEasy.tradeWizard.amount.seller.limitInfo.overlay.info.scoreTooLow" to "Your reputation score of {0} doesn''t offer sufficient security for buyers.\n\nBuyers who consider to take your offer will receive a warning about potential risks when taking your offer.\n\nYou can find information on how to increase your reputation at ''Reputation/Build Reputation''.",
            ...
            "bisqEasy.openTrades.tradeDetails.lightningInvoice" to "Lighting invoice",
            ...
            "bisqEasy.tradeWizard.amount.addMinAmountOption" to "Add min/max range for amount",
            ...
            "bisqEasy.tradeWizard.directionAndMarket.feedback.headline" to "How to build up reputation?",
            ...
            "bisqEasy.price.tradePrice.inputBoxText" to "Trade price in {0}",
            ...
            "bisqEasy.price.percentage.title" to "Percentage price",
            ...
            "bisqEasy.openTrades.failed" to "The trade failed with error message: {0}",
            ...
            "bisqEasy.tradeState.info.buyer.phase2a.reasonForPaymentInfo" to "Please leave the 'Reason for payment' field empty, in case you make a bank transfer",
            ...
            "bisqEasy.tradeWizard.amount.seller.limitInfo.noReputationNeededForMaxOrFixedAmount" to "For amounts up to {0} no reputation is required.",
            ...
            "bisqEasy.tradeWizard.directionAndMarket.feedback.gainReputation" to "Learn how to build up reputation",
            ...
            "bisqEasy.price.percentage.inputBoxText" to "Market price percentage between -10% and 50%",
            "bisqEasy.takeOffer.amount.seller.limitInfo.overlay.info.scoreTooLow" to "For amounts up to {0} the reputation requirements are relaxed.\n\nYour reputation score of {1} doesn''t offer sufficient security for the buyer. However, given the low trade amount the buyer accepted to take the risk.\n\nYou can find information on how to increase your reputation at ''Reputation/Build Reputation''.",
            ...
            "bisqEasy.tradeWizard.amount.seller.wizard.numMatchingOffers.info" to "There {0} matching the chosen trade amount.",
            ...
            "bisqEasy.tradeWizard.amount.buyer.limitInfo.noReputationNeededForMaxOrFixedAmount.riskInfo" to "Be sure you fully understand the risks involved.",
            ...
            "bisqEasy.tradeWizard.amount.buyer.limitInfo.overlay.info" to "A seller who wants to take your offer of {0}, must have a reputation score of at least {1}.\nBy reducing the maximum trade amount, you make your offer accessible to more sellers.",
            "bisqEasy.tradeState.info.buyer.phase2a.tradeLogMessage" to "{0} initiated the {1} payment",
            "bisqEasy.takeOffer.amount.seller.limitInfo.scoreTooLow" to "As your reputation score is only {0} your trade amount is restricted to",
            ...
            "bisqEasy.price.feedback.sentence" to "Your offer has {0} chances to be taken at this price.",
            ...
            "bisqEasy.tradeWizard.amount.buyer.limitInfo" to "There {0} in the network with sufficient reputation to take an offer of {1}.",
            ...
            "bisqEasy.tradeWizard.amount.buyer.limitInfo.wizard.info.leadLine" to "There {0} matching the chosen trade amount.",
            "bisqEasy.tradeWizard.amount.buyer.limitInfo.overlay.linkToWikiText" to "To learn more about the reputation system, visit:",
            ...
            "bisqEasy.openTrades.tradeDetails.open" to "Open trade details",
        ...
        "reputation" to mapOf(
            ...
            "reputation.buildReputation.intro.part2" to "If a seller posts an offer with an amount not covered by their reputation score, the buyer will see a warning about the potential risks when taking that offer.",
        ...
        "chat" to mapOf(
            ...
            "chat.message.takeOffer.buyer.makersReputationScoreTooLow.no" to "No, I look for another offer",
            ...
            "chat.message.takeOffer.seller.myReputationScoreTooLow.warning" to "Your reputation score is {0} and below the required reputation score of {1} for the trade amount of {2}.\n\nThe security model of Bisq Easy is based on the seller''s reputation.\nTo learn more about the reputation system, visit: [HYPERLINK:https://bisq.wiki/Reputation].\n\nYou can read more about how to build up your reputation at ''Reputation/Build Reputation''.",
            ...
            "chat.message.takeOffer.seller.myReputationScoreTooLow.headline" to "Your reputation score is too low for taking that offer",
            ...
            "chat.message.takeOffer.buyer.makersReputationScoreTooLow.headline" to "Security warning",
            ...
            "chat.message.takeOffer.buyer.makersReputationTooLowButInLowAmountTolerance.headline" to "Please review the risks when taking that offer",
            ...
            "chat.message.takeOffer.buyer.makersReputationTooLowButInLowAmountTolerance.no" to "No, I look for another offer",
        ...
        "user" to mapOf(
            ...
            "user.profileCard.reputation.totalReputationScore" to "Total Reputation Score",
            ...
            "user.profileCard.details.lastUserActivity" to "Last user activity",
            ...
            "user.profileCard.details.totalReputationScore" to "Total reputation score",
            ...
            "user.profileCard.details.version" to "Software version",
        ...
        "settings" to mapOf(
            ...
            "settings.trade.maxTradePriceDeviation.invalid" to "Must be a value between 1 and {0}%",

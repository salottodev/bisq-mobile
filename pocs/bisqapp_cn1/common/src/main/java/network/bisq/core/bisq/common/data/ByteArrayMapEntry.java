...
public final class ByteArrayMapEntry implements PersistableProto {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.ByteArrayMapEntry toProto(boolean serializeForHash) {
        return resolveProto(serializeForHash);
    }

    @Override
    public network.bisq.core.bisq.common.protobuf.ByteArrayMapEntry.Builder getBuilder(boolean serializeForHash) {

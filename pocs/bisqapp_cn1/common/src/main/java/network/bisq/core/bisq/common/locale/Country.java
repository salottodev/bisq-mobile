...
public final class Country implements PersistableProto {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.Country.Builder getBuilder(boolean serializeForHash) {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.Country toProto(boolean serializeForHash) {

...
import network.bisq.core.bisq.common.currency.CryptoCurrencyRepository;
...
public final class Coin extends Monetary {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.Monetary toProto(boolean serializeForHash) {
        return resolveProto(serializeForHash);
    }

    @Override
    public network.bisq.core.bisq.common.protobuf.Monetary.Builder getBuilder(boolean serializeForHash) {

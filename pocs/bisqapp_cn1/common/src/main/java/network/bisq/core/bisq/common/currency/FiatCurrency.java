...
import network.bisq.core.bisq.common.locale.LocaleRepository;
...
public final class FiatCurrency extends TradeCurrency {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.TradeCurrency.Builder getBuilder(boolean serializeForHash) {
        return getTradeCurrencyBuilder().setFiatCurrency(bisq.common.protobuf.FiatCurrency.newBuilder());
    }

    @Override
    public network.bisq.core.bisq.common.protobuf.TradeCurrency toProto(boolean serializeForHash) {

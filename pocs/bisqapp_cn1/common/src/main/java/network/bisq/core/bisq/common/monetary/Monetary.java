...
package network.bisq.core.bisq.common.monetary;

import network.bisq.core.bisq.common.currency.TradeCurrency;
import network.bisq.core.bisq.common.proto.PersistableProto;
import network.bisq.core.bisq.common.proto.UnresolvableProtobufMessageException;
import network.bisq.core.bisq.common.util.MathUtils;
import network.bisq.core.bisq.common.validation.NetworkDataValidation;
...
public abstract class Monetary implements Comparable<Monetary>, PersistableProto {
    ...
    public static Monetary fromProto(bisq.common.protobuf.Monetary proto) {
        switch (proto.getMessageCase()) {
            ...
            case MESSAGE_NOT_SET:
                throw new UnresolvableProtobufMessageException("MESSAGE_NOT_SET", proto);
            default:
                throw new IllegalArgumentException("Unknown message case: " + proto.getMessageCase());
        }
    }
    ...
    private boolean compare(Monetary other, int precision, ComparisonOperator comparisonOperator) {
        ...
        switch (comparisonOperator) {
            case IS_LESS_THAN:
                result = valueForPrecision < otherValueForPrecision;
                break;

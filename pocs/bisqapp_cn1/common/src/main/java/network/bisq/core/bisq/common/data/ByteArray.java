...
package network.bisq.core.bisq.common.data;

import network.bisq.core.bisq.common.encoding.Hex;
...
public final class ByteArray implements PersistableProto, Comparable<ByteArray> {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.ByteArray toProto(boolean serializeForHash) {
        return resolveProto(serializeForHash);
    }

    @Override
    public network.bisq.core.bisq.common.protobuf.ByteArray.Builder getBuilder(boolean serializeForHash) {

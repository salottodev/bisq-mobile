...
import network.bisq.core.bisq.common.proto.NetworkProto;
...
public final class Market implements NetworkProto, PersistableProto, Comparable<Market> {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.Market.Builder getBuilder(boolean serializeForHash) {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.Market toProto(boolean serializeForHash) {

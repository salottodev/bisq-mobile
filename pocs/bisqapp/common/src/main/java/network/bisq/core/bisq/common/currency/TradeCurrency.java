...
package network.bisq.core.bisq.common.currency;

import network.bisq.core.bisq.common.annotation.ExcludeForHash;
...
public abstract class TradeCurrency implements Comparable<TradeCurrency>, PersistableProto {
    ...
    public network.bisq.core.bisq.common.protobuf.TradeCurrency.Builder getTradeCurrencyBuilder() {

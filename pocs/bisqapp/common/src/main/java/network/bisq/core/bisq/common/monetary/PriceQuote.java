...
import network.bisq.core.bisq.common.currency.Market;
...
public final class PriceQuote implements Comparable<PriceQuote>, PersistableProto {
    ...
    @Override
    public network.bisq.core.bisq.common.protobuf.PriceQuote toProto(boolean serializeForHash) {
        return resolveProto(serializeForHash);
    }

    @Override
    public network.bisq.core.bisq.common.protobuf.PriceQuote.Builder getBuilder(boolean serializeForHash) {

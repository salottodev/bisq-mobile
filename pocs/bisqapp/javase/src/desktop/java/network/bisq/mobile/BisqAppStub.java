 ...
 * @author Shai Almog
 */
public class BisqAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "BisqApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new BisqAppStub());
    }
